...
- Rich audio-list actions: ATPlayer has table/context-menu workflows such as metadata/info dialogs and broader audio actions; ATCinna now covers compact popup info plus audio URL/title/genre/topic copy actions, but still lacks deeper table-level audio workflows.
