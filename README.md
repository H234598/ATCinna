...
- In der Audioinformation sind **Datum**, **Zeit**, **Dauer [min]**, **Neu** und **Podcast** als sichtbare Einzelzeilen sowie **URL** und **Website** als klickbare Info-Zeilen eingebaut; bei Aktivierung der Links wird der sichere `xdg-open`-Pfad verwendet.
...
- Paketierung (`0.3.84`): `./scripts/package.sh` erzeugt `dist/atcinna@H234598-<version>.tar.gz`.
- Runtime-Smoke:
