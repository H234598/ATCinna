...
- Warteschlange im Applet kann per Untermenü pro Eintrag geordnet werden: Download stoppen, Audio (URL) abspielen, Download (URL) kopieren, gespeichertes Audio (Datei) abspielen, Zielordner öffnen, aus Liste entfernen, vorziehen und zurückstellen.
...
- Paketierung (`0.3.11`): `./scripts/package.sh` erzeugt `dist/atcinna@H234598-<version>.tar.gz`.
- Runtime-Smoke:
