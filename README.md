...
- Warteschlangen-Menü mit ATPlayer-nahen Auswahlaktionen für die sichtbare Queue-Liste: Alles auswählen, Auswahl umkehren, Tabelle zurücksetzen, Audio (URL) abspielen, Download (URL) kopieren, Downloads starten, Downloads vorziehen/Downloads zurückstellen, Downloads stoppen und Downloads aus der Liste entfernen.
...
- Paketierung (`0.3.42`): `./scripts/package.sh` erzeugt `dist/atcinna@H234598-<version>.tar.gz`.
- Runtime-Smoke:
